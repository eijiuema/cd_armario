...
-- out_sp[1]	=>  Location: PIN_W19,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- out_sp[2]	=>  Location: PIN_U18,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- out_b[1]	=>  Location: PIN_V18,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- out_b[2]	=>  Location: PIN_U17,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- out_sn[3]	=>  Location: PIN_AD22,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- fechar	=>  Location: PIN_N25,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
SIGNAL \ok~clk_delay_ctrl_clkout\ : std_logic;
...
SIGNAL \Integrador4|Porta1|regSenha1|FF_B1|QS~feeder_combout\ : std_logic;
...
SIGNAL \Integrador2|Porta1|regSenha1|FF_B1|QS~feeder_combout\ : std_logic;
...
SIGNAL \regButtons1|FF_B2|QS~feeder_combout\ : std_logic;
...
SIGNAL \Integrador3|Porta1|regSenha1|FF_B3|QS~feeder_combout\ : std_logic;
...
\ok~clkctrl_INCLK_bus\ <= (gnd & gnd & gnd & \ok~clk_delay_ctrl_clkout\);
...
-- Equation(s):
-- \Integrador1|Selector0~2_combout\ = (!\cancel~combout\ & (!\Integrador1|Porta1|abreFecha1|Sp~regout\ & \ok~combout\))
...
-- Equation(s):
-- \Integrador3|Porta1|e_ss~combout\ = LCELL((\Integrador3|estado.aberto_s~regout\ & \regButtons1|FF_B2|QS~regout\))
...
-- Equation(s):
-- \Integrador2|Selector1~0_combout\ = (\ok~combout\ & (!\cancel~combout\ & (!\Integrador2|Porta1|abreFecha1|Sp~regout\ & \Integrador2|Porta1|e_clr~0_combout\)))
...
PORT MAP (
	...
	datad => \Integrador2|Porta1|e_clr~0_combout\,
	combout => \Integrador2|Selector1~0_combout\);

-- Location: LCCOMB_X64_Y12_N8
\Integrador2|Selector1~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \Integrador2|Selector1~1_combout\ = (\Integrador2|estado.aberto_s~regout\ & (!\cancel~combout\ & ((!\fechar~combout\) # (!\Integrador2|Porta1|abreFecha1|Sp~regout\))))
...
-- Equation(s):
-- \Integrador2|Selector1~2_combout\ = (\Integrador2|Selector1~0_combout\) # ((\Integrador2|Selector1~1_combout\) # ((\Integrador2|estado.aberto_s~regout\ & !\regButtons1|FF_B1|QS~regout\)))
...
-- Equation(s):
-- \Integrador4|Selector1~0_combout\ = (\ok~combout\ & (!\cancel~combout\ & (\Integrador4|Porta1|e_clr~0_combout\ & !\Integrador4|Porta1|abreFecha1|Sp~regout\)))
...
PORT MAP (
	dataa => \ok~combout\,
	datab => \cancel~combout\,
	datac => \Integrador4|Porta1|e_clr~0_combout\,
...
\ok~clk_delay_ctrl\ : cycloneii_clk_delay_ctrl
-- pragma translate_off
GENERIC MAP (
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	clkout => \ok~clk_delay_ctrl_clkout\);
...
-- pragma translate_on
PORT MAP (
	dataa => \Integrador4|Selector1~0_combout\,
...
\Integrador4|Porta1|regSenha1|FF_B1|QS~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \Integrador4|Porta1|regSenha1|FF_B1|QS~feeder_combout\ = \regSenha1|FF_B1|QS~regout\
...
-- pragma translate_on
PORT MAP (
	datad => \regSenha1|FF_B1|QS~regout\,
	combout => \Integrador4|Porta1|regSenha1|FF_B1|QS~feeder_combout\);

-- Location: LCFF_X63_Y11_N29
\Integrador4|Porta1|regSenha1|FF_B1|QS\ : cycloneii_lcell_ff
PORT MAP (
	clk => \Integrador4|Porta1|e_ss~clkctrl_outclk\,
	datain => \Integrador4|Porta1|regSenha1|FF_B1|QS~feeder_combout\,
	aclr => \Integrador4|Porta1|e_clr~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- pragma translate_on
PORT MAP (
	dataa => \Integrador4|Porta1|Sc~1_combout\,
...
-- Equation(s):
-- \Integrador4|Porta1|Sc~combout\ = (\Integrador4|Porta1|Sc~0_combout\ & (\Integrador4|Porta1|Sc~1_combout\ & \regButtons1|FF_B3|QS~regout\))
...
\Integrador2|Porta1|regSenha1|FF_B1|QS~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \Integrador2|Porta1|regSenha1|FF_B1|QS~feeder_combout\ = \regSenha1|FF_B1|QS~regout\
...
PORT MAP (
	datad => \regSenha1|FF_B1|QS~regout\,
	combout => \Integrador2|Porta1|regSenha1|FF_B1|QS~feeder_combout\);
...
-- Equation(s):
-- \Integrador2|Selector0~0_combout\ = (\Integrador2|Porta1|abreFecha1|Sp~regout\ & (((\Integrador2|Porta1|Sc~0_combout\ & \Integrador2|Porta1|Sc~1_combout\)) # (!\Integrador2|estado.aberto~regout\)))
...
-- Equation(s):
-- \Integrador2|Selector0~1_combout\ = (\Integrador2|estado.aberto~regout\ & ((\Integrador2|estado.aberto_s~regout\ & (!\cancel~combout\)) # (!\Integrador2|estado.aberto_s~regout\ & ((!\Integrador2|Selector0~0_combout\))))) # 
-- (!\Integrador2|estado.aberto~regout\ & (((!\cancel~combout\ & !\Integrador2|Selector0~0_combout\))))
...
-- Equation(s):
-- \Integrador2|Selector0~2_combout\ = (\regButtons1|FF_B1|QS~regout\ & (\Integrador2|Selector0~1_combout\ & ((\ok~combout\) # (\Integrador2|estado.aberto~regout\)))) # (!\regButtons1|FF_B1|QS~regout\ & (((\Integrador2|estado.aberto~regout\))))
...
PORT MAP (
	clk => \Integrador2|Porta1|e_ss~clkctrl_outclk\,
	datain => \Integrador2|Porta1|regSenha1|FF_B1|QS~feeder_combout\,
	aclr => \Integrador2|Porta1|e_clr~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \Integrador2|Porta1|Sc~0_combout\ = (\regSenha1|FF_B1|QS~regout\ & (\Integrador2|Porta1|regSenha1|FF_B1|QS~regout\ & (\Integrador2|Porta1|regSenha1|FF_B0|QS~regout\ $ (!\regSenha1|FF_B0|QS~regout\)))) # (!\regSenha1|FF_B1|QS~regout\ & 
-- (!\Integrador2|Porta1|regSenha1|FF_B1|QS~regout\ & (\Integrador2|Porta1|regSenha1|FF_B0|QS~regout\ $ (!\regSenha1|FF_B0|QS~regout\))))
...
PORT MAP (
	...
	datab => \Integrador2|Porta1|regSenha1|FF_B1|QS~regout\,
	datac => \Integrador2|Porta1|regSenha1|FF_B0|QS~regout\,
...
-- Equation(s):
-- \Integrador2|Porta1|Sc~combout\ = (\Integrador2|Porta1|Sc~1_combout\ & (\Integrador2|Porta1|Sc~0_combout\ & \regButtons1|FF_B1|QS~regout\))
...
PORT MAP (
	...
	datab => \Integrador2|Porta1|Sc~0_combout\,
	datad => \regButtons1|FF_B1|QS~regout\,
...
-- Equation(s):
-- \Integrador1|Selector1~1_combout\ = (!\cancel~combout\ & (\Integrador1|estado.aberto_s~regout\ & ((!\fechar~combout\) # (!\Integrador1|Porta1|abreFecha1|Sp~regout\))))
...
-- Equation(s):
-- \Integrador1|Selector1~0_combout\ = (!\cancel~combout\ & (\ok~combout\ & (!\Integrador1|Porta1|abreFecha1|Sp~regout\ & \Integrador1|Porta1|e_clr~0_combout\)))
...
PORT MAP (
	...
	datab => \ok~combout\,
	datac => \Integrador1|Porta1|abreFecha1|Sp~regout\,
	datad => \Integrador1|Porta1|e_clr~0_combout\,
...
PORT MAP (
	dataa => \regSenha1|FF_B3|QS~regout\,
	datab => \regSenha1|FF_B2|QS~regout\,
	datac => \Integrador1|Porta1|regSenha1|FF_B2|QS~regout\,
	datad => \Integrador1|Porta1|regSenha1|FF_B3|QS~regout\,
...
-- Equation(s):
-- \Integrador1|Porta1|Sc~0_combout\ = (\regSenha1|FF_B1|QS~regout\ & (\Integrador1|Porta1|regSenha1|FF_B1|QS~regout\ & (\regSenha1|FF_B0|QS~regout\ $ (!\Integrador1|Porta1|regSenha1|FF_B0|QS~regout\)))) # (!\regSenha1|FF_B1|QS~regout\ & 
...
-- Equation(s):
-- \Integrador1|Porta1|Sc~combout\ = (\regButtons1|FF_B0|QS~regout\ & (\Integrador1|Porta1|Sc~0_combout\ & \Integrador1|Porta1|Sc~1_combout\))
...
PORT MAP (
	dataa => \regButtons1|FF_B0|QS~regout\,
	datab => \Integrador1|Porta1|Sc~0_combout\,
	datad => \Integrador1|Porta1|Sc~1_combout\,
...
\regButtons1|FF_B2|QS~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \regButtons1|FF_B2|QS~feeder_combout\ = \decButtons1|dec_b[1]~1_combout\
...
-- pragma translate_on
PORT MAP (
	datad => \decButtons1|dec_b[1]~1_combout\,
	combout => \regButtons1|FF_B2|QS~feeder_combout\);

-- Location: LCFF_X61_Y11_N31
\regButtons1|FF_B2|QS\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ok~combout\,
	datain => \regButtons1|FF_B2|QS~feeder_combout\,
	aclr => \reg_clear~0clkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \Integrador3|Selector1~0_combout\ = (\ok~combout\ & (!\cancel~combout\ & (!\Integrador3|Porta1|abreFecha1|Sp~regout\ & \Integrador3|Porta1|e_clr~0_combout\)))
...
PORT MAP (
	...
	datad => \Integrador3|Porta1|e_clr~0_combout\,
...
-- Equation(s):
-- \Integrador3|Selector0~0_combout\ = (\Integrador3|Porta1|abreFecha1|Sp~regout\ & (((\Integrador3|Porta1|Sc~0_combout\ & \Integrador3|Porta1|Sc~1_combout\)) # (!\Integrador3|estado.aberto~regout\)))
...
PORT MAP (
	...
	datac => \Integrador3|Porta1|Sc~1_combout\,
	datad => \Integrador3|Porta1|abreFecha1|Sp~regout\,
...
PORT MAP (
	dataa => \cancel~combout\,
	datab => \Integrador3|estado.aberto_s~regout\,
...
\Integrador3|Porta1|regSenha1|FF_B3|QS~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \Integrador3|Porta1|regSenha1|FF_B3|QS~feeder_combout\ = \regSenha1|FF_B3|QS~regout\
...
PORT MAP (
	datad => \regSenha1|FF_B3|QS~regout\,
	combout => \Integrador3|Porta1|regSenha1|FF_B3|QS~feeder_combout\);

-- Location: LCFF_X62_Y11_N29
\Integrador3|Porta1|regSenha1|FF_B3|QS\ : cycloneii_lcell_ff
PORT MAP (
	clk => \Integrador3|Porta1|e_ss~clkctrl_outclk\,
	datain => \Integrador3|Porta1|regSenha1|FF_B3|QS~feeder_combout\,
	aclr => \Integrador3|Porta1|e_clr~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	...
	datac => \Integrador3|Porta1|regSenha1|FF_B2|QS~regout\,
	datad => \Integrador3|Porta1|regSenha1|FF_B3|QS~regout\,
	combout => \Integrador3|Porta1|Sc~1_combout\);

-- Location: LCCOMB_X62_Y11_N24
\Integrador3|Porta1|Sc\ : cycloneii_lcell_comb
-- Equation(s):
-- \Integrador3|Porta1|Sc~combout\ = (\Integrador3|Porta1|Sc~1_combout\ & (\regButtons1|FF_B2|QS~regout\ & \Integrador3|Porta1|Sc~0_combout\))
...
-- Equation(s):
-- \out_sc~0_combout\ = (\Integrador4|Porta1|Sc~combout\) # ((\Integrador2|Porta1|Sc~combout\) # ((\Integrador1|Porta1|Sc~combout\) # (\Integrador3|Porta1|Sc~combout\)))
...
PORT MAP (
	...
	datab => \Integrador2|Porta1|Sc~combout\,
	datac => \Integrador1|Porta1|Sc~combout\,
	datad => \Integrador3|Porta1|Sc~combout\,
	combout => \out_sc~0_combout\);

-- Location: LCCOMB_X62_Y11_N10
\invalid_s~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \invalid_s~0_combout\ = (\regSenha1|FF_B1|QS~regout\ & (\regSenha1|FF_B0|QS~regout\ & (\regSenha1|FF_B2|QS~regout\ & \regSenha1|FF_B3|QS~regout\))) # (!\regSenha1|FF_B1|QS~regout\ & (!\regSenha1|FF_B0|QS~regout\ & (!\regSenha1|FF_B2|QS~regout\ & 
...
-- Equation(s):
-- \out_b~0_combout\ = (\regButtons1|FF_B0|QS~regout\ & !\invalid_s~0_combout\)
